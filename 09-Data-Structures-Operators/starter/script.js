...
const ceckMidleSeat = function (seat) {
  //B and E are middle seats
  const s = seat.slice(-1);
  if (s === `B` || s === `E`) console.log(`You got ther middle seat`);
...
console.log(`Claudiu Hancu`.split(` `));
const [firsName, lastName] = `Claudiu Hancu`.split(` `);
